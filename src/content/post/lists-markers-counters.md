...
I'm working on a solution to the [Tech book club landing page challenge on Frontend Mentor](https://www.frontendmentor.io/challenges/tech-book-club-landing-page-fZQidjHU73) and needed to refresh my memory about styling list in CSS. My goal was to get an idea how I could style the lists on the landing page.
...
- [Creative list styling](https://web.dev/articles/creative-list-styling) by Michelle Barker for web.dev: A look at a number of different ways to style lists

:::note
I used custom list markers before, in my [Frontend Mentor - Recipe page solution](https://github.com/SabineEmden/fm-recipe-page). That was two years ago, and I didn't recall all the details. I did, however, find the starting point for this reading list in the README.
:::

The landing page has four unordered lists with an SVG checkmark icon as list markers. The icon is part of the image assets in the starter files. Similar to the unordered lists on the recipe page, the markers are centered vertically if the list item wraps over two or more lines.

There is also an ordered list on the landing page. Its list counters are positioned above the list items and have a border.
